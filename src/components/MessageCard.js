...
const MessageCard = ({ name, email, company, message, id, fetchMessage }) => {
    ...
    return (
        <div className='bg-gradient-to-tr from-gray-100 to-gray-300 hover:from-gray-300 hover:to-gray-100 px-3 md:px-6 pt-2 pb-6 flex flex-col gap-x-4 hover:scale-105 duration-150 font-basic'>
