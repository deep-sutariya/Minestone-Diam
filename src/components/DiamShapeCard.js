    ...
    return (
        <div className={"flex relative items-start my-2 sm:my-3 hover:scale-105 duration-150 min-w-[80%] sm:min-w-[370px] drop-shadow-xl" + direction} alt='img'>
            <div className='h-60 sm:h-80 w-full shade-bg'>
                <Image className='noDrag absolute top-0 left-0 -z-50 w-full h-60 sm:h-80 opacity-90 object-cover' src={CubeLogo} width={500} height={500} alt={`${heading} Image`} onContextMenu={(e) => e.preventDefault()}/>
