...
const Affiliations = () => {
  return (
    <div className=" w-full bg-[#252525] flex flex-col lg:px-5 pt-10 pb-16 md:px-2 md:py-20  md:gap-y-10 justify-center items-center text-offwhite">
      ...
      <div className='grid grid-cols-3 gap-y-5 gap-x-1 sm:gap-x-0 px-1 mt-9 w-[98%] md:w-[90%]'>
        <AffiliationCard
          link="https://gjepc.org/"
          y={-100}
          classNames="w-full h-20 md:h-24 lg:h-24 xl:h-32"
        ...
        <AffiliationCard
          ...
          y={100}
          classNames="w-full h-20 md:h-24 xl:h-28 p-2 md:px-6"
