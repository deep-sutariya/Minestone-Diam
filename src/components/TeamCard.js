...
const TeamCard = ({ name, surname, role }) => {
    return (
        <div className=" duration-150 flex-1">
            <TranslateFragment y="100">
                ...
                <div className="flex flex-col justify-center items-center"> 
                    <div className="text-[9px] md:text-lg lg:text-2xl font-heading font-semibold">{name}</div>
                    <div className="text-[9px] md:text-lg lg:text-2xl font-heading font-semibold">{surname}</div>
                </div>
