...
export const metadata = {
    ...
    title: {
        ...
        default: 'Code of Conduct | Minestone Diam',
    },
    keywords: [
        'Minestone Diam', 'code of conduct', 'ethical practices',
        'corporate responsibility', 'business ethics', 'diamond industry',
        'trusted diamond partner', 'sustainable diamonds', 'Surat diamonds'
    ],
    openGraph: {
        description: 'Learn about Minestone Diam\'s Code of Conduct and our commitment to ethical practices.',
    }
};
