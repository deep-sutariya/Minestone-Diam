...
export const metadata = {
    ...
    title: {
        ...
        default: 'Terms & Conditions | Minestone Diam',
    },
    keywords: [
        'Minestone Diam', 'terms and conditions', 'legal agreement',
        'website terms', 'user agreement', 'diamond industry',
        'trusted diamond partner', 'ethical diamonds', 'Surat diamonds'
    ],
    openGraph: {
        description: 'Review the Terms & Conditions of Minestone Diam for using our website and services.',
    }
};
