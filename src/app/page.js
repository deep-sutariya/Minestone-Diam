  ...
  return (
    <div className=' relative overflow-x-clip' >
      <div className=" bg-offwhite h-[calc(100dvh)] w-full flex flex-row items-end md:items-normal md:gap-x-5 overflow-x-clip">
        <div className=" md:mt-36 w-[100%] sm:w-2/3 md:w-[56%] px-2 sm:px-5 md:px-10 lg:pl-20 lg:pr-0 pt-16 pb-6 sm:py-16 md:py-24 flex flex-col sm:justify-end md:justify-normal gap-y-3 sm:gap-y-6">
          <div className=" flex flex-col justify-start items-start gap-y-1 lg:gap-y-4 font-heading text-black text-3xl lg:text-5xl 2xl:text-6xl">
            <h1>Luxuriate in Boldness</h1>
            <h1>Trust the Brilliance</h1>
          </div>
          <p className=" w-full font-basic text-detail text-xs md:text-lg lg:text-lg xl:text-xl text-left">We emphasize the peace of mind of owning a diamond-backed by trust and transparency. Minestone Diam uses state-of-the-art tech to help diamond jewellers, retailers and buyers experience growth like never before. A sustainable & user friendly solution to source the best quality diamonds at the best price, scale up profits, expand business horizons, and grow exponentially.</p>
        </div>
