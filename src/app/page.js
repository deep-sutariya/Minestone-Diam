  ...
  return (
    <div className=' relative overflow-x-clip' >
      <div className=" bg-offwhite h-[calc(100dvh)] w-full flex flex-row items-end md:items-normal md:gap-x-5 overflow-x-clip">
        <div className=" mb-10 md:mt-36 w-[100%] sm:w-2/3 md:w-[56%] px-2 sm:px-5 md:px-10 lg:pl-20 lg:pr-0 pt-16 pb-6 sm:py-16 md:py-24 flex flex-col sm:justify-end md:justify-normal gap-y-3 sm:gap-y-6">
        ...
        <div className=' absolute -top-0 -right-[340px] sm:top-0 sm:-right-[320px] md:top-16 md:-right-[520px] lg:top-16 lg:-right-[620px] z-10 w-fit h-min'>
